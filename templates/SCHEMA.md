...
Compute sha256 over the body only (everything after the closing `---`), not the frontmatter.
...
## Entity Pages
One page per notable entity: overview, key facts, relationships ([[wikilinks]]), sources.

## Concept Pages
One page per concept: definition, current knowledge, open questions, related concepts.

## Comparison Pages
Side-by-side analyses: what is compared, dimensions (table preferred), verdict, sources.
